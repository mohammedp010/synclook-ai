...
def test_product_relevance_reports_metrics() -> None:
    ...
    assert summary["matcher"] == "keyword_baseline"


def test_keyword_baseline_meets_floor() -> None:
    """Regression guard on the current matcher; Phase 3 reranker must beat this."""
    report = evaluate_product_relevance()
    summary = report["summary"]
